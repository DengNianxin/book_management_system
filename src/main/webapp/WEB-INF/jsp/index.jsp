...
<!-- 欢迎信息警告框 -->
<div id="welcomeAlert" class="alert alert-success alert-dismissible" style="display: none; position: fixed; top: 20px; left: 50%; transform: translateX(-50%); z-index: 1000;">
